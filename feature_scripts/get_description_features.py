...
with open("detail_description_data/detail-desc-text-{}.tsv".format(sys.argv[1]),'r') as tsvin:
    ...
    for row in tsvin:
        ...
        try:
            ...
            fig_counts = detail_description_text.lower().count("fig.") + detail_description_text.lower().count("figs.")
...
with open("feature_data/description_features/description_features_{}.json".format(sys.argv[1]), 'w') as f:
